...
namespace HandsFree {
    class Blob {
        ...
        public int ComputeMaxWidth() {
            ...
            foreach (Point pt in Data) imageMaxWidth.Data[pt.Y - YMin, pt.X - XMin, 0] = 255;
            int maxWidth = 0;
            for (int j = Height; j >= 0; j--) {
                ...
                for (int i = Width; i >= 0; i--) {
                    if (imageMaxWidth.Data[j, i, 0] == 255)
                        if (started) endX = i;
                        else { started = true; startX = i; endX = i; }
                }
        ...
        public int ComputeMedianWidth() {
            ...
            foreach (Point pt in Data) imageMediaWidth.Data[pt.Y - YMin, pt.X - XMin, 0] = 255;
            ...
            if (widths.Count > 0) { widths.Sort(); return widths[widths.Count / 2]; }
            return 0;
        }
    }
}
